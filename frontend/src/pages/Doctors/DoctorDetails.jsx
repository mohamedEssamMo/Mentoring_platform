            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-[6px]">
                  <span className="flex items-center gap-[6px] test-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                ...
                <p className="text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellendus, quibusdam.
                  Illo molestiae distinctio quod perferendis esse, 
                  totam corrupti pariatur officiis,
                </p>
              </div>
            </div>
