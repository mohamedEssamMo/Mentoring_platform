    ...
    <div className="container">
      ...
      <section>
        <div className='container'>
          ...
          <div className='flex flex-wrap items-center justify-between flex-col md:flex-row gap-5 lg:gap-
          [30px] mt-[30px] lg:mt-[55px]'>
            </div>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className='xl:w-[670px]'>
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">3. View our physicians who are accepting new patients, use 
